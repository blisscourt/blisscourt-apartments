...
const DuplexApartment = () => {
  // State for guest selector dropdown
  ...
  const bookApartment = async (e) => {
    ...
    const bookingDetails = {
      bookingType: "Full Duplex",
      checkIn: checkInDate,
      checkOut: checkOutDate,
      adults: adults,
      children: childrenCount,
      phoneNumber: phoneNumber,
      apartmentType: "Duplex Apartment",
    };
  ...
  return (
    <main className="pt-40 bg-[#f9f9f9] min-h-screen font-sans py-12 px-4 md:px-8 lg:px-16 text-[#333333]">
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start relative">
        ...
        <div className="lg:col-span-2 space-y-8 bg-white p-4 md:p-6 rounded-md shadow-sm border border-neutral-100">
          ...
          <div className="text-left space-y-6 px-2 md:px-6">
            ...
            <p className="text-neutral-600 font-light leading-relaxed text-sm md:text-base">
              ...
              beautifully furnished 4-bedroom duplex offers the perfect home
              away from home for both short and extended stays. Whether you’re
              visiting Lagos for business, leisure, family gatherings, or
              relocation, Bliss Court provides a welcoming environment tailored
              to meet your needs.
            </p>

            <p className="text-neutral-600 font-light leading-relaxed text-sm md:text-base">
              Guests have the flexibility to book the entire duplex for
              exclusive use—ideal for families, corporate teams, and group
              travelers—or reserve individual en-suite rooms for a private,
              comfortable, and budget-friendly stay.
            </p>

            <div className="pt-4">
              <h3 className="text-lg font-medium text-neutral-800 mb-3">
                Why Choose Bliss Court?
              </h3>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs md:text-sm text-neutral-600 font-light">
                ...
                <li className="flex items-start gap-2">• Smart TVs</li>
                <li className="flex items-start gap-2">
        ...
        {/* Right Side: Updated Booking Form Widget aligned with image_808146.png */}
        <div className="bg-white p-6 rounded-md shadow-md border border-neutral-100 sticky top-6 z-10">
          ...
          <div className="space-y-4">
            ...
            >
              {loading ? "Booking..." : "Book Full Duplex"}
            </button>
